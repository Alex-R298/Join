    ...
    <div class="edit-task-content">
        ...
        <div class="input-with-label">
            ...
            <div class="assigned-section">
                        ...
                        ${usersArray.map(user => `
                            <div class="assigned-user-item" data-name="${user.name.toLowerCase()}">
                                ...
                                <div class="custom-checkbox">
                                    ...
                                    <label for="edit-user-${user.email}" class="checkbox-label">
                                        <span class="checkbox-custom"></span>
                                    </label>
                                </div>
                            </div>
                ...
                <div id="edit-assigned-avatars" class="assigned-avatars">
        ...
        <div class="input-with-label">
            ...
            <div class="input-with-button">
                ...
                <div class="subtask_buttons">
                    <button id="editAddButton" onclick="addEditSubtask()">+</button>
                    <button id="editAcceptButton" onclick="addEditSubtask()" style="display: none;">&#10003;</button>
                    <button id="editClearButton" onclick="clearEditInput()" style="display: none;">X</button>
                </div>
            </div>
